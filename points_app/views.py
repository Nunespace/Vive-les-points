...
def bareme(request):
    ...
    return render(request, "points_app/bareme.html")


class IndexView(ListView):
    template_name = "points_app/index.html"
...
class DetailView(DetailView):
    model = Enfant
    template_name = "points_app/historique.html"
...
class NewPointsView(View):
    ...
    template_name = "points_app/new_points.html"
    success_url = "accueil"
